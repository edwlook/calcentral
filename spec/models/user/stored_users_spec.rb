...
describe User::StoredUsers do
  ...
  describe "#get" do
    ...
    it "should return list of users stored by the current user" do
      ...
      User::SearchUsersByUid.should_receive(:new).twice.with({id: stored_uid}).and_return(stub_model)
      stub_model.should_receive(:search_users_by_uid).twice.and_return(fake_ldap_user)
