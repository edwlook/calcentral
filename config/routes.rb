Calcentral::Application.routes.draw do
  ...
  # Rails API endpoints.
  get '/api/my/am_i_logged_in' => 'user_api#am_i_logged_in', :as => :mystatus, :defaults => { :format => 'json' }
  get '/api/my/status' => 'user_api#mystatus', :as => :mystatus2, :defaults => { :format => 'json' }
  ...
  get '/api/my/research' => 'my_research_groups#get_feed', :as => :research, :defaults => { :format => 'json' }
  ...
  get '/api/my/videos/:playlist_title' => 'my_videos#get_videos', :constraints => { :playlist_title => /[^\/]+/ }, :defaults => { :format => 'json' }
  ...
  get '/canvas/lti_course_provision' => 'canvas_lti#lti_course_provision', :defaults => { :format => 'xml' }
  ...
  get '/api/academics/canvas/course_provision_as/:admin_acting_as' => 'canvas_course_provision#get_feed', :as => :canvas_course_provision2, :defaults => { :format => 'json' }
  ...
  get '/api/blog/release_notes/latest' => 'blog_feed#get_latest_release_notes', :as => :blog_latest_release_notes, :defaults => { :format => 'json' }
